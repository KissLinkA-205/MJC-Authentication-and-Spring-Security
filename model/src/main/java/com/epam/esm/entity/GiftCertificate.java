...
import com.epam.esm.audit.GiftCertificateAuditingListener;
...
public class GiftCertificate extends Identifiable {
    ...
    public boolean equals(Object o) {
        ...
        return price.compareTo(that.price) == 0 && duration == that.duration && Objects.equals(name, that.name)
                ...
                && Objects.equals(tags, that.tags) && deleted == that.deleted;
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), name, description, price, duration, createDate, lastUpdateDate, tags, deleted);
    }
    ...
    public String toString() {
        ...
        result.append(", deleted=").append(deleted);
        result.append('}');
