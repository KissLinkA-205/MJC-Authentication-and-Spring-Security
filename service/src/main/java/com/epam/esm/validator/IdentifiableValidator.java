...
public class IdentifiableValidator {
    ...
    private final String DELETED_FLAG = "true";
    private final String NOT_DELETED_FLAG = "false";
     ...
     *
     * @param deletedFlag deleted flag string type
     * @param er          the object to which the validation results will be written
     */
    public void validateDeletedFlag(String deletedFlag, ExceptionResult er) {
        if (!(deletedFlag.equalsIgnoreCase(DELETED_FLAG) || deletedFlag.equalsIgnoreCase(NOT_DELETED_FLAG))) {
            er.addException(BAD_DELETED_FLAG, deletedFlag);
        }
    }
}
