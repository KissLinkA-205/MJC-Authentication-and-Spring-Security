...
public class OrderServiceImpl extends AbstractService<Order> implements OrderService {
    ...
    @Autowired
    public OrderServiceImpl(JpaRepository<Order, Long> dao, DateHandler dateHandler, OrderDao orderDao,
    ...
    public Order insert(Order order) {
        ...
        if (optionalGiftCertificate.get().isDeleted()) {
            exceptionResult.addException(GIFT_CERTIFICATE_DELETED);
            throw new IncorrectParameterException(exceptionResult);
        }
