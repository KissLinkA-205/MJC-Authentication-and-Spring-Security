...
class GiftCertificateServiceImplTest {
    ...
    private static final GiftCertificate GIFT_CERTIFICATE_1 = new GiftCertificate(1, "giftCertificate1",
            ...
            new Tag(2, "tagName3"), new Tag(3, "tagName5")), false);
    ...
    private static final GiftCertificate GIFT_CERTIFICATE_2 = new GiftCertificate(2, "giftCertificate3",
            ...
            LocalDateTime.parse("2019-08-29T06:12:15.156"), Collections.singletonList(new Tag(2, "tagName3")), false);
    ...
    private static final GiftCertificate GIFT_CERTIFICATE_3 = new GiftCertificate(3, "giftCertificate2",
            ...
            LocalDateTime.parse("2018-08-29T06:12:15.156"), null, false);
    private static final GiftCertificate GIFT_CERTIFICATE_FOR_INSERT = new GiftCertificate(0, "giftCertificate",
            "description", new BigDecimal("10"), 1, LocalDateTime.parse("2020-08-29T06:12:15.156"),
            LocalDateTime.parse("2020-08-29T06:12:15.156"), null, false);
    ...
    void testGetAll() {
        ...
        when(giftCertificateDao.findAll(pageRequest).toList()).thenReturn(giftCertificates);
    ...
    void testInsert() {
        ...
        when(giftCertificateDao.save(GIFT_CERTIFICATE_FOR_INSERT)).thenReturn(GIFT_CERTIFICATE_FOR_INSERT);

        GiftCertificate actual = giftCertificateService.insert(GIFT_CERTIFICATE_FOR_INSERT);
        GiftCertificate expected = GIFT_CERTIFICATE_FOR_INSERT;
